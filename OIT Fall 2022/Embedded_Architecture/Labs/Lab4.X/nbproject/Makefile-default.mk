...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/lab4.o: lab4.c  .generated_files/flags/default/ce6c54b91c5bb8c322994aa4ad9f7d1fab736ab0 .generated_files/flags/default/c8f49664b0402dfc7fb4da4c6ec79c30a0012f45
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lab4.o.d 
	@${RM} ${OBJECTDIR}/lab4.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -fno-common -MP -MMD -MF "${OBJECTDIR}/lab4.o.d" -o ${OBJECTDIR}/lab4.o lab4.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
	
else
${OBJECTDIR}/lab4.o: lab4.c  .generated_files/flags/default/f82f1e86fff055193561e602a60aa2410d31324c .generated_files/flags/default/c8f49664b0402dfc7fb4da4c6ec79c30a0012f45
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lab4.o.d 
	@${RM} ${OBJECTDIR}/lab4.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -fno-common -MP -MMD -MF "${OBJECTDIR}/lab4.o.d" -o ${OBJECTDIR}/lab4.o lab4.c    -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -mdfp="${DFP_DIR}"  
