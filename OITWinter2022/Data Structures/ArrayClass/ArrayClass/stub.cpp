/*************************************************************
* Author: Chris Thomas
* Filename: ArrayClass.cpp
* Date Created: 1/5/2022 9:15 PM
* Modifications: N/A
**************************************************************/

/*************************************************************
*
* Lab/Assignment: Lab 1 – Single Dimensional Array
*
* Overview:
* This program stub was provided by Todd Breedlove to test our
* Single Dimensional Array. The Array class should make sure
* lenghts are valid, make sure the user never goes out of bounds,
* the user should be able to set the lenght of the array at any time
* even allowing smaller lengths that could lead to data loss. The 
* user should have the capability of specifying a negative starting index.
* The program should also include and Exception class that will handle 
* the exceptions should be specifying an index smaller than the lower bounds
* and specifying an index larger than the upper bounds.
*
* Input:
* Inputs are all provided by Todd to test array.
*
* Output:
* The output of this program will be a series of statements on whether or not
* the specific passed or failed. I also added some output of "Exception!" when
