...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/lab3.o: lab3.S  .generated_files/flags/default/e1a0ea7909b1a65d9169bb1c5ac80b848a5a9f11 .generated_files/flags/default/411a0bba36ae87630292d0c795f181b015b09521
	@${MKDIR} "${OBJECTDIR}" 
	...
	@${FIXDEPS} "${OBJECTDIR}/lab3.o.d" "${OBJECTDIR}/lab3.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../ 
	
else
${OBJECTDIR}/lab3.o: lab3.S  .generated_files/flags/default/2fa14d1c008438b3a39a249b3dacedd4bb73fe55 .generated_files/flags/default/411a0bba36ae87630292d0c795f181b015b09521
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lab3.o.d 
	@${RM} ${OBJECTDIR}/lab3.o 
	@${RM} ${OBJECTDIR}/lab3.o.ok ${OBJECTDIR}/lab3.o.err 
	${MP_CC} $(MP_EXTRA_AS_PRE)  -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/lab3.o.d"  -o ${OBJECTDIR}/lab3.o lab3.S  -DXPRJ_default=$(CND_CONF)  -legacy-libc  -Wa,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_AS_POST),-MD="${OBJECTDIR}/lab3.o.asm.d",--gdwarf-2 -mdfp="${DFP_DIR}"
	@${FIXDEPS} "${OBJECTDIR}/lab3.o.d" "${OBJECTDIR}/lab3.o.asm.d" -t $(SILENT) -rsi ${MP_CC_DIR}../ 
