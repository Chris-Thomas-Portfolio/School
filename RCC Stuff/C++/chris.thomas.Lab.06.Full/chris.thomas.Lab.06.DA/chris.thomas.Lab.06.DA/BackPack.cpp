...
BackPack::BackPack(DynamicArray<Potion> pots)
{
	m_potions = pots;
}
...
/**********************************************************************
* Purpose: This function removes an item from the list in BackPack
*
* Precondition:	Need a BackPack that contains a List.
*
* Postcondition: Removes a particular item from the list.
*
************************************************************************/

void BackPack::DeleteItem(Potion name)
{
	m_potions.Delete(name);
}
