/*************************************************************
* Author:		Chris Thomas
* Filename:		chris.thomas.Lab.01.Potion.cpp
...
int main()
{
	Potion Health("Health Potion", "Restores a large amount of Health", "Strong", "1.1.1.50");
	Potion Mana("Mana Potion", "Restores a small amount of Mana", "Weak", "0.0.1.0");
	Potion Stamina("Stamina Potion", "Restores a moderate amount of Stamina", "Medium", "0.1.0.50");
