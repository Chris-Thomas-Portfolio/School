...
*	int PlatConversion()
*		Converts the string of the platinum cost to an int.
*	int GoldConversion()
*		Converts the string of the gold cost to an int.
*	int SilverConversion()
*		Converts the string of the silver cost to an int.
*	int CopperConversion()
*		Converts the string of the copper cost to an int.
*************************************************************************/
