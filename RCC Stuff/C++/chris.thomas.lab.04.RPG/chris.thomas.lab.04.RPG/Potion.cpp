...
void Potion::Display()
{
	...
	platinum += Conversion() / 1000000;
	gold += (Conversion() % 1000000) / 10000;
	silver += ((Conversion() % 1000000) % 10000) / 100;
	copper += ((Conversion() % 1000000) % 10000) % 100;
	...
	cout << "Cost: " << platinum << " Platinum, " << gold << " Gold, " << silver << " Silver, " << copper << " Copper" << endl;
}
