/*************************************************************
* Author:		Chris Thomas
* Filename:		chris.thomas.Lab.03.cpp
* Date Created:	5/6/2020
* Modifications:	N/A
**************************************************************/
/*************************************************************
*
* Lab/Assignment: Lab 3 –  DynamicArray Class
*
* Overview:
*	This program will create an array of potions using my own
*	DynamicArray class.
*
* Input:
...
int main()
{
	...
	DynamicArray Belt;																								// create an array of potions
	
	//Belt.Insert(Health);																							// add a health potion to array
	//Belt.Insert(Mana);																								// add a mana potion to array
	//Belt.Insert(Stamina);																							// add a stamina potion to array
	
	cout << Belt.GetElements() << endl;

	try
	{
		Belt.Delete(Stamina);																						// delete the Mana Potion from array
	}
	catch (int except)
	{
		if (except == NO_POTION)
			cout << "No Potions to delete" << endl;
	}
